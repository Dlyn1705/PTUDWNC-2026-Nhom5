...
Dựa trên bảng phân chia trách nhiệm tính năng (FR/OBS/JOB) của Nhóm 5, tài liệu này quy hoạch chi tiết **các trang (pages), màn hình, components, hooks và dịch vụ phía client** mà từng thành viên đảm nhiệm trong thư mục `culinary-blog-web/`.
